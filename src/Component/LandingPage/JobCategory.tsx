...
const JobCategory = () => {
    return (
        <div className="mt-20 pb-5">
            <div className="text-4xl md-mx:text-3xl sm-mx:text-2xl xs-mx:text-xl mb-3 text-center font-bold text-mine-shaft-100 [&>span]:text-bright-sun-400">Browse <span>Job</span> Category</div>
            <div className="text-lg sm-mx:text-base xs-mx:text-sm mb-10 mx-auto text-mine-shaft-300 text-center w-1/2 sm-mx:w-11/12">Explore diverse job opportunities tailored to your skills. Start your career  journey  today!</div>
            ...
            >
                {
                    jobCategory.map((category, idx) => (
                        <Carousel.Slide key={idx}>
                            <div  className="flex flex-col items-center w-64 sm-mx:w-56 xs-mx:w-48  gap-2 my-5  border border-bright-sun-400 p-5 rounded-lg hover:cursor-pointer hover:shadow-[0_0_5px_2px_black] !shadow-bright-sun-300 transition duration-300 ease-in-out">
