...
const CertiInput = (props: any) => {
    ...
    const handleSave = () => {
        ...
        certi[certi.length - 1].issueDate instanceof Date ? certi[certi.length - 1].issueDate.toISOString() : new Date(certi[certi.length - 1].issueDate).toISOString();
        
        let updatedProfile = {...profile , certifications:certi};
        props.setEdit(false);

        dispatch(changeProfile(updatedProfile));
        successNotification("Success", "Certificate Addedd Successfully.")
    }
